...
public class NioReadEachLine2 {

 

	public static void main(String args[]) throws Exception { 

		int bufSize = 10000;//一次读取的字节长度

		File fin = new File("C:/temp/钢瓶押金2018_12_24.csv");//读取的文件

		File fout = new File("C:/temp/钢瓶押金2018_12_24_w.csv");//写出的文件
