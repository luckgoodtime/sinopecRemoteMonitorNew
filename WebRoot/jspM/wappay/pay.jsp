<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.lng.util.AlipayConfig" %>
...
<script language="javascript">
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "testOrderPay";
		document.getElementById("WIDtotal_amount").value = "0.01";
        document.getElementById("WIDbody").value = "testOrderPay0.01yuan";
	}
	GetDateNow();
