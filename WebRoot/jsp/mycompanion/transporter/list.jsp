...
$(function(){
  $(".click").click(function(){
 	window.location.href="<%=request.getContextPath()%>/transporter/addOrUpdate.do";
  });
	...
	<body>
		...
		<div class="rightinfo">
			...
			<form id="myForm" action="<%=request.getContextPath()%>/transporter/del.do" method="post">
				...
				<tbody>
					...
					<c:forEach items="${p.dataList}" var="o">
						<tr>
							...
							<td>
								<a href="<%=request.getContextPath()%>/transporter/addOrUpdate.do?id=${o[0].id}" class="tablelink">修改</a>
								&nbsp;&nbsp;
							</td>
						</tr>
					</c:forEach>
