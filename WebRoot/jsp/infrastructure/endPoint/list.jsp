...
$(function(){
  $(".click").click(function(){
 	window.location.href="<%=request.getContextPath()%>/endPoint/addOrUpdate.do";
  });
	...
	<body>
		...
		<div class="rightinfo">
			...
			<form id="myForm" action="<%=request.getContextPath()%>/endPoint/del.do" method="post">
				...
				<tbody>
					...
					<c:forEach items="${p.dataList}" var="o">
						<tr>
							...
							<td>
								<a href="<%=request.getContextPath()%>/endPoint/addOrUpdate.do?partyId=${o.partyId}" class="tablelink">修改</a>
								&nbsp;&nbsp;
