...
$(function(){
  $(".click").click(function(){
 	window.location.href="<%=request.getContextPath()%>/article/addOrUpdate.do";
  });
	...
	<body>
		...
		<div class="rightinfo">
			...
			<form id="myForm" action="<%=request.getContextPath()%>/article/del.do" method="post">
				...
				<tbody>
					...
					<c:forEach items="${p.dataList}" var="o">
						<tr>
							...
							<td>
								<a href="<%=request.getContextPath()%>/article/addOrUpdate.do?id=${o.id}" class="tablelink">修改</a>
								&nbsp;&nbsp;
